...
func (ie *thirdPartiesEvaluator) Calculate(d exago.Data) *exago.EvaluatorResponse {
	...
	imp, cs := d.Results.ThirdParties.Data, d.Results.CodeStats.Data
